# descarga todos los archivos .csv de la encuesta ENE al especificar un año
...
# descargar todos
walk(enlaces_ene, \(enlace) {
  
  archivo <- str_extract(enlace, "ene-202.*")
  
  message(paste("descargando", archivo))
  
  download.file(enlace, destfile = paste0("datos/originales/", archivo))
